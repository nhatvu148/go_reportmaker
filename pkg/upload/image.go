...
func GetClientBuildPath() string {
	return setting.AppSetting.ClientBuildPath
}

func GetClientBuildFullPath() string {
	return setting.AppSetting.RuntimeRootPath + GetClientBuildPath()
}
